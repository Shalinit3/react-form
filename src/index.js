...
import Radio from './components/radioButton/index.js';
...
class Form extends Component {
  formSubmit = (e) => {
    ...
    if (this.gender.state.isValid && this.name.state.isValid && this.email.state.isValid && this.phone.state.isValid
      ...
      console.log(this.gender.state.value, this.name.state.value, this.email.state.value, this.phone.state.value,
